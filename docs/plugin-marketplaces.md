...
> 来源: https://code.claude.com/docs/zh-CN/plugin-marketplaces
...
插件条目可以覆盖默认组件位置并提供其他元数据。注意 `${CLAUDE_PLUGIN_ROOT}` 是一个环境变量，解析为插件的安装目录：
...
- [插件](./plugins.md) - 安装和使用插件
- [插件参考](./plugins-reference.md) - 完整的技术规范和架构
